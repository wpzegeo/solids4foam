...
- For this training, you can download solids4foam from this temporary address:
https://drive.google.com/drive/folders/14rl8jXtlcvnGL-rbMCZeDDpKW4oThNjP?usp=sharing 

    Tiny URL: https://tinyurl.com/y5qfjpvw 
...
## Installing solids4foam using **Docker**
  ...
  **Docker Desktop (Preferred solution)** : Docker Engine is available on a variety of Linux platforms, Mac and Windows through Docker Desktop.
...
- Create a solids4foam container:
```
